...
/* 
    ...
    "Full Width Post" and "full-width-post.php" is just made up custom name, 
    but the "File Header", Template Name, plays a role to make this page a template page
 
    Doing so, we see an option named "Full Width Post" inside Pages=>All Pages=>Template: drop down box.
            ...
            <div class="single-post nobottommargin">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php 
                        /* nl2br() is a php function that will convert new line to <br> html tag */ 
                ...
                <div class="related-posts clearfix">
                    ...
                    <?php
                    endwhile;
                    wp_reset_postdata(); // ending the secondary Loop
                endif;
                ?>
                </div>
