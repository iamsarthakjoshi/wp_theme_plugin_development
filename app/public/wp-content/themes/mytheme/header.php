	...
	<div id="top-bar" class="dark">
		<div class="container clearfix">
			...
			<div class="col_half fright col_last nobottommargin">
				...
				<div id="top-social">
					<ul>
						<?php if(get_theme_mod('sj_facebook_setting')) : ?>
						<li><a href="https://facebook.com/<?php echo get_theme_mod('sj_facebook_setting');?>" class="si-facebook"><span class="ts-icon"><i class="icon-facebook"></i></span><span class="ts-text">Facebook</span></a></li>
						<?php endif; ?>
		...
		<div id="header-wrap">
			...
			<nav id="primary-menu" class="style-2">
				<div class="container clearfix">
					...
					<!-- Top Search -->
					<?php if(get_theme_mod('sj_show_search_setting')) : ?>
					<div id="top-search">
